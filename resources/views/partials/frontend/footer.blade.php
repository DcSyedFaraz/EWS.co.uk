<footer class="bg-[#174A4E] pt-10">
    <div class="container mx-auto">
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-y-4">
            ...
            <div class="text-center sm:text-left mx-10">
                ...
                <hr class="border-2 border-primary-one mx-auto sm:mx-0 w-1/5 my-2">
                <ul class="my-2 text-white space-y-2 font-medium ">
                    <li>
                ...
                <ul class="my-2 text-white space-y-2 font-medium">
                    ...
                    <li>
                        <a href="{{ route('policy.terms-and-conditions') }}" class=" hover:text-primary-one ">
            ...
            <div class="text-center sm:text-left mx-10">
                <h4 class="uppercase text-xl font-bold text-primary-one">Our Services</h4>
                <hr class="border-2 border-primary-one mx-auto sm:mx-0 w-1/5 my-2">
                <ul class="my-2 text-white space-y-2 font-medium">
                    {{-- @if(!empty($services))
                    @for ($i=0 ; $i<=11 ;$i++)
                    <li>
                        <a href="{{ route('service.show',$services[$i]->slug) }}" class=" hover:text-primary-one "> {{ $services[$i]->name }} </a>
                    </li>
                    @endfor
                    @endif --}}
                </ul>
            ...
            <div class="text-center sm:text-left mx-10">
                <h4 class="uppercase text-xl font-bold text-primary-one">Other Services</h4>
                <hr class="border-2 border-primary-one mx-auto sm:mx-0 w-1/5 my-2">
                <ul class="my-2 text-white space-y-2 font-medium">
                    {{-- @if(!empty($services))
                    @for ($i=12 ; $i<=24 ;$i++)
            ...
            <div class="text-center sm:text-left mx-10">
                ...
                <ul class="my-2 text-white space-y-2 font-medium">
                    ...
                    <li>
                        <a href="https://api.whatsapp.com/send?phone={{ $web_setting->contact }}" class=" hover:text-primary-one "> <i class="fa fa-whatsapp mr-2"></i> Whatsapp </a>
                    </li>
                    <li>
                        <a href="mailto:{{ $web_setting->email }}" class=" hover:text-primary-one "> <i class="fa fa-envelope-o mr-2"></i>  info@4poundessay.co.uk </a>
                    </li>
    ...
    <div class="bg-[#174A4E]">
        <div
            class="container text-white mx-auto flex flex-col lg:flex-row items-center space-y-4 lg:space-y-0 justify-between py-3 md:px-10">
            <p class="mx-6 text-center sm:mx-0 sm:text-left">
               <span class="text-lg font-semibold">© {{ now()->year }} 4poundessay.co.uk. All Rights Reserved. </span>
            </p>
            <ul class="flex flex-col md:flex-row items-center space-x-4">
                ...
                <li class="">
                    <img src="../imgs/payment.png" class="" alt="{{ env('APP_NAME') }}">
                </li>
            </ul>
        </div>
    </div>
